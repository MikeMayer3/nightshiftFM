...
replacements = {'BROADCAST_ALL_CONNECTIONS': 'All connections', 'BROADCAST_READY_CONNECTIONS': 'Ready connections', 'BROADCAST_NO_CONNECTIONS': 'No connections ready. Go live or browse the recipes.', 'MENU_START': 'New broadcast', 'BOOT_EYEBROW': 'OFFLINE • STATION DEFENSE', 'BOOT_SUBTITLE': 'Keep the signal alive.', 'BOOT_FOOTER': 'Original radio instruments • Modern rivals', 'BROADCAST_PATCH_HINT': 'Choose a socket. Connect a ready pair. Go live.', 'BROADCAST_DETAILS': 'Details +', 'BROADCAST_HIDE_DETAILS': 'Details −', 'BROADCAST_GUARDED': 'GUARDED', 'BROADCAST_OPEN': 'OPEN', 'BROADCAST_CHANNEL': 'TUNING', 'BROADCAST_VOLLEY': 'PACKETS', 'BROADCAST_MUTED': 'MUTED'}
for row in rows:
